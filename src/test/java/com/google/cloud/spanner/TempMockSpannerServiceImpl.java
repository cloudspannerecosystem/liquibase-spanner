 ...
 * TempMockSpannerServiceImpl#putStatementResult(StatementResult)}. Note that the SQL statements
 * that are put as statement results are not parsed and are only used as a key know which result to
 ...
 * }</pre>
 *
 * TODO: This is a temporary copy-paste from the client library as the liquibase-spanner tests rely
 * on a test method that is not yet available in a production release of the Spanner client library.
 * Remove this file once {@link #putPartialStatementResult(StatementResult)} is available in the
 * Spanner client library.
 */
public class TempMockSpannerServiceImpl extends SpannerImplBase implements MockGrpcService {
  ...
  /** The result of a statement that is executed on a {@link TempMockSpannerServiceImpl}. */
  ...
  public static class SimulatedExecutionTime {
     ...
     *     call on a {@link TempMockSpannerServiceImpl}.
     */
